...
}).addTo(mymap); // returns a Promise of filtered csv array from all_data
...
function drawPoints() {
  ...
  filter_data().then(function (d) {
    d.map(function (row) {
      var fill = ""; // get color based on class
      ...
      circle.bindPopup("<b>Name:</b> " + row["name"] + "<br>" + "<b>ID: </b>" + row["id"] + "<br>" + "<b>Class: </b>" + row["recclass"] + "<br>" + "<b>Mass (g): </b>" + row["mass"] + "<br>" + "<b>Geolocation: </b>(" + row["reclat"] + ", " + row["reclong"] + ")");
    });
  });
} // Draw points (meteorites) on the map


drawPoints(); // Update the current slider value and render a new plot

slider.oninput = function () {
  output.innerHTML = this.value;
  year = this.value; // TODO: Update the plot here:

  drawPoints();
};
},{"d3":"../node_modules/d3/index.js","./Meteorite_Landings.csv":"Meteorite_Landings.csv"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62370" + '/');
